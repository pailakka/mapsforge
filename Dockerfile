...
COPY --from=builder /home/gradle/project/mapsforge-map-writer/build/libs/mapsforge-map-writer-master-SNAPSHOT-jar-with-dependencies.jar /app/osmosis/plugins/
CMD /app/osmosis/bin/osmosis